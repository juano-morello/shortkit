...
**F-028 | ADDRESSED.** Constants land in the stub directly beneath `LOCAL_LIMITER_MAX_TENANTS` (`/home/juano/Workspaces/JustJuanoDev/.sdlc/foundation/design/stubs/apps/api/src/common/rate-limit/rate-limit.types.ts:218`), all three rules stated in both stub and contract.
...
findings:
  - severity: major
    kind: design
    file: .sdlc/foundation/design/stubs/apps/api/src/common/rate-limit/rate-limit.types.ts
    line: 113
  ...
  - severity: major
    kind: design
    file: .sdlc/foundation/design/adr-0012-redis-client-and-rate-limit-degradation.md
    line: 110
  ...
  - severity: minor
    kind: design
    file: .sdlc/foundation/design/contracts/web-api-client.md
    line: 83
