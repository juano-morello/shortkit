...
findings:
  ...
  - severity: minor
    kind: contract
    file: .sdlc/foundation/design/adr-0022-logging-cors-and-security-headers.md
    line: 78
    summary: >-
    ...
    failure_scenario: >-
      `.sdlc/foundation/tasks/TASK-003.md:55` says "CORRECTED 2026-08-06: TASK-009 is in WAVE
...
- **Whether `.sdlc/` is present in every environment `pnpm test` runs in.** The new drift spec
  reads `../../../../.sdlc/foundation/design/contracts/logging-and-headers.md` from
