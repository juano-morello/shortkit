...
>
> **The corrections point at `design/contracts/isolation-coverage.md` rather than repeating
...
`design/contracts/isolation-coverage.md`, "Attempt semantics", and it is not restated here.**
