...
None. `.sdlc/launch-core/state.yaml`'s new TASK-003 entry lists only `acceptance: [AC-6]`. Nothing in the diff touches `.github/**`, `apps/web/**`, or anything under AC-5/AC-7/AC-113/AC-114's territory.
