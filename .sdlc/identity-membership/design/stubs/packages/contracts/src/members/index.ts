 ...
 */
export function parseTenantMembership(_value: unknown): TenantMembership {
  throw new Error('not implemented');
}

/** Kept importable so a caller that has already parsed can brand without re-parsing. */
export function brandTenantMembership(_wire: TenantMembershipWire): TenantMembership {
  throw new Error('not implemented');
}
