...
- The narrowing is a type, and types erase. `betterAuthDatabase().execute(sql\`select * from
  ...
  additional one.
- `design/contracts/tenant-context.md`'s "What the implementer must guarantee" opens with
