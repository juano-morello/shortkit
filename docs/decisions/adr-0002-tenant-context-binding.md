...
a fast third-party call, and nothing greps for one. `docs/contracts/tenant-context.md`
...
- Added 2026-08-05 (F-120): `client.ts` also exports `postgresErrorCode` and
  ...
  parameter. `docs/contracts/tenant-context.md`, "Driver errors inside `fn`", is
  normative.
